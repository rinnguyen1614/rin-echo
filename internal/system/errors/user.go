...
var (
	...
	ErrCannotChangeUsernameOfAdmin = core.NewRinError("cannot_change_username_of_admin", "Can not change username of the admin.")
	ErrCannotDeleteAdmin           = core.NewRinError("cannot_delete_admin", "Can not delete the admin.")
)
